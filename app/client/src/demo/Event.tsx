...
import { Chart } from '../components/_lightweightChart'

export function Event(props: RouteComponentProps) {
  return (
    <>
      <Typography.Title>Leo vel fringilla est ullamcorper eget nulla facilisi</Typography.Title>
      <Tag>parent-event</Tag>
      <Tag>$ABC</Tag>
      <Tag>$OPQ</Tag>
      <p />
